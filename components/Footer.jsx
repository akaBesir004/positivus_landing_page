    ...
    <div className="max-w-screen-xl mx-auto lg:px-16 px-8 mt-8">
      <div className="px-12 py-12   bg-[#191A23] text-white mt-8 rounded-t-3xl flex-wrap lg:flex-nowrap gap-12 ">
        ...
        <div className="flex flex-col lg:flex-row">
            ...
            <p className="mb-4 text-center lg:text-left">Email: info@positivus.com</p>
            <p className="mb-4 text-center lg:text-left">Phone: 555-567-8901</p>
            <p className="text-center lg:text-left">Address: 1234 Main St
          ...
          <ul className="lg:hidden flex-row gap-6 justify-center underline flex mt-6">
                <Image src="/images/twitter.png" alt="Twitter" width={30} height={30} className="rounded-3xl "/>
                <Image src="/images/facebook.jpg" alt="Facebook" width={30} height={30} className="rounded-3xl "/>
                <Image src="/images/instagram.jpg" alt="Instagram" width={30} height={30} className="rounded-3xl "/>
